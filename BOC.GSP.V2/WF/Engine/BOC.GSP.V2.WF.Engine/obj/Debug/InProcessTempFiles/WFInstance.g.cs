...
namespace BOC.GSP.V2.WF.Engine {
    ...
    public partial class WFInstance : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<BOC.GSP.V2.WF.Common.Variable.ActivityPara> _para;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<BOC.GSP.V2.WF.Common.Variable.ActivityPara> para {
            get {
                return this._para;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(WFInstance).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(WFInstance));
        ...
        private string FindResource() {
            string[] resources = typeof(WFInstance).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".WFInstance.g.xaml") || resource.Equals("WFInstance.g.xaml"))) {
                    return resource;
                }
            }
